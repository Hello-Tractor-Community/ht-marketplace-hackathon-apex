...
const SettingsSidebar = ({ isMobile, currentTab, setCurrentTab }) => {
  return (
    <div
      className={`flex gap-2 ${isMobile ? "w-full flex-col sm:flex-row" : "w-[20%] h-64 flex-col"} showdow p-2 border rounded-md overflow-auto scrollbar-hidden`}
    >
      <h3 className="text-[24px] fw-bold  font-satoshi">Dashboard </h3>
      <div
