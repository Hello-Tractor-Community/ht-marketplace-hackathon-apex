...
const TrainedOperators = () => {
    ...
    const operators = [
        ...
        },
        {
            name: 'Emma Gray',
            image: 'https://via.placeholder.com/150',
            location: 'Graystone, Country',
            phone: '+2233445566',
            email: 'emagray@example.com'
        },
    ];

    return (
        <div className="py-5 px-4 sm:px-8 lg:px-16 overflow-hidden">
            <h2 className="text-2xl font-bold text-gray-800 mb-4">Trained Tractor Operators</h2>
